...
/**
 * Created by Carlos on 30/08/2017.
 */
...
public class Descargar extends AsyncTask<String, Integer, Estado> {
    ...
    protected Estado doInBackground(String... sUrl) {
        ...
        try {
            ...
            return new Estado(ERROR,e.getMessage());
//si hay excepciones las retornamos usando la clase estado
        } finally {
//finalmente
            try {
//cerramos los flujos de entrada y salida
    ...
    protected void onProgressUpdate(Integer... progress) {//esto ocurre mientras se descarga
        ...
        prgCargar.setProgress(progress[0]);
    }
    @Override
